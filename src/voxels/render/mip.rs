...
use super::compute::MIP_SHADER_HANDLE;
...
impl ViewNode for MipNode {
    ...
    fn run(
        ...
        let mip_bind_group = render_device.create_bind_group(
            None,
            &pipelines.mip_bind_group_layout,
            &[
                BindGroupEntry {
                    binding: 0,
                    resource: BindingResource::TextureView(&texture_view),
